...
[.lead]
dbs.provisioned EMS events occur when the distributed block store detects that the overall provisioned capacity of the cluster has exceeded the slice reserve space threshold.
