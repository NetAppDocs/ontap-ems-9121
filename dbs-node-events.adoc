...
[.lead]
dbs.node EMS events occur when ONTAP encounters issues associated with the maintenance mode or communication status of a node in the distributed block store cluster.
