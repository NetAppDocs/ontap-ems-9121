...
[.lead]
oss.eventept EMS events occur when ONTAP encounters issues associated with the connection between an event endpoint and the ONTAP(R) Status Service (OSS) server.
