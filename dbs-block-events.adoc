...
[.lead]
dbs.block EMS events occur when a Distributed Block Store (DBS) completes a block service repair operation involving block rewrites to replica BServices.
