...
[.lead]
dbs.ensemble EMS events occur when ONTAP encounters issues associated with the Distributed Block Store (DBS) database ensemble, such as lost connectivity to ensemble nodes.
