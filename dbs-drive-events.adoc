...
[.lead]
dbs.drive EMS events occur when ONTAP encounters issues associated with Distributed Block Store (DBS) drive operations, such as a drive capacity mismatch.
