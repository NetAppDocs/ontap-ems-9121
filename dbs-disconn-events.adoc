...
[.lead]
dbs.disconn EMS events occur when ONTAP encounters issues associated with network connectivity between cluster pairs or remote nodes in the Distributed Block Store (DBS).
