...
[.lead]
coredump.long EMS events occur when ONTAP encounters issues associated with the coredump manager thread taking longer than expected to process a message.
