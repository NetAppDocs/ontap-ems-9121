...
[.lead]
hypervisor.phy EMS events occur when ONTAP encounters issues associated with the physical network interfaces on the hypervisor not meeting ONTAP(R) Select requirements.
