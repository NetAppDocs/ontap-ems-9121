...
[.lead]
dbs.sw EMS events occur when a Distributed Block Store (DBS) event related to Software Encryption At Rest (SEAR) occurs, such as a master key rekey completing or failing.
