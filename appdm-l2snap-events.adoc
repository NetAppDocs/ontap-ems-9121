...
[.lead]
appdm.l2snap EMS events occur when ONTAP encounters issues associated with Snapshot copy create or delete requests between the storage system and the host.
