...
[.lead]
dbs.remote EMS events occur when ONTAP encounters issues associated with remote cluster connectivity or paused remote replication in the distributed block store.
