...
[.lead]
flexcache.autogrow EMS events occur when automatically growing a FlexCache volume fails because the cluster-wide FlexCache provisioned space has exceeded the licensed limit.
