...
[.lead]
dbs.service EMS events occur when ONTAP encounters issues associated with the status of a Distributed Block Store (DBS) service, such as a service failing to start or run.
