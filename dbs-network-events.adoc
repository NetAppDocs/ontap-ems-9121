...
[.lead]
dbs.network EMS events occur when ONTAP encounters issues associated with network configuration, connectivity, or MTU size in the distributed block store cluster.
