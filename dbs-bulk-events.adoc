...
[.lead]
dbs.bulk EMS events occur when a Distributed Block Store (DBS) event related to bulk volume operations, such as backups, restores, Snapshot copies, or cloning, occurs.
